...
ruta_archivo <- "C:/Users/denny/Documents/Programación/programacion_estadistica/R/test.csv"  # <-- CAMBIA ESTA RUTA
...
ggplot(df_clean, aes(x = factor(Sex))) +
...
write_xlsx(df_clean, "C:/Users/denny/Documents/Programación/programacion_estadistica/R/titanic_test_limpio.xlsx")  # Esto guardará el archivo en tu carpeta de trabajo

write.csv(df_clean, "C:/Users/denny/Documents/Programación/programacion_estadistica/R/titanic_test_limpio.csv") 